...
* Repository in [https://github.com/lzhbrian/Pattern-Recognition-Homework-RBM](https://github.com/lzhbrian/Pattern-Recognition-Homework-RBM)
...
1. 写在前面 overall
    ...
    2. 关于网络上的教程
    3. 关于本篇报告
2. 浅显易懂的解释 Introduction of RBM、DBN、Pretrain、Finetuning
    1. 受限波尔兹曼机 RBM
    2. 深度置信网 DBN
...
4. 我的工作 Configure a DBN
    ...
    3. 训练效果
    4. 结论
5. 写在后面 —— 关于我, 关于模式识别课程 About me, About Pattern Recognition
...
### 1. 写在前面 Overall:
***
* 这个大作业,我使用了[DeepLearning4j](http://deeplearning4j.org)（以下简称DL4J）的库,在IntelliJ IDEA CE的IDE上进行编程。
* About
...
* 我尝试使用了Python的[Theano](http://deeplearning.net/),以及[SciPy](http://scikit-learn.org/)＋[Opencv](http://opencv.org)的组合等;
